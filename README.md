...
> **Статус: ранняя версия.** Конвейер сборки работает целиком: `heron new` создаёт сайт, `heron build` собирает его в статику или в образ. Впереди — обкатка на реальных сайтах, публичного релиза пока нет.
